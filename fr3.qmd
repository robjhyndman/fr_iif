...
\only<2->{\begin{textblock}{7.3}(0.8,5.9)
...
\only<3>{\begin{textblock}{6.7}(8.5,5.9)
...
* Simulate future sample paths for each series using a multivariate bootstrap of the residuals from each model.
...
\begin{textblock}{7}(8.7,1.3)\fontsize{11}{11.5}\sf
...
\nocite{smartmeterhts,coherentprob}
