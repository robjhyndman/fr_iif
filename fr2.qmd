...
If $\bS\bG$ is a projection, then the trace of $\bm{V}_h$ is \textbf{minimized} when
...
@di2023spatio propose an effective nonnegative heuristic called "set-negative-to-zero"

  * Negative reconciled forecasts at the bottom level are set to zero
...
See also @Di_FonGir2022b. @ZhaEtAl2022.
