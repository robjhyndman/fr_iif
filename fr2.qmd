...
* @nonnegmint propose an efficient quadratic programming solution.

\vspace*{0.2cm}\pause\begin{alertblock}{Heuristic alternative:}
Set bottom-level negative reconciled forecasts to zero, and then compute the remaining forecasts via aggregation\\\mbox{}\hfill\citep{Di_FonGir2022b}
\end{alertblock}
...
* @zhang2023optimal: propose quadratic programming solution
* @HPT21
